...
| [`workflows/CheckpointedWindowSusie.wdl`](workflows/CheckpointedWindowSusie.wdl) | `CheckpointedWindowSusieWorkflow` | Fine-map one prepared window with durable GCS checkpoints. |
